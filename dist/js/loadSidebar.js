 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function $t(t,e,n=!1){const i="signIn",r=await Bt(t,i,e),s=await Ut._fromIdTokenResponse(t,i,r);return n||await t._updateCurrentUser(s.user),s}new WeakMap;const Kt="__sak";
/**
 * @license
 * Copyright 2019 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Qt extends Ht{constructor(){super((()=>window.sessionStorage),"SESSION")}_addListener(t,e){}_removeListener(t,e){}}Qt.type="SESSION";const Xt=Qt;
/**
 * @license
 * Copyright 2019 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Be=new T(5e3,15e3),ze="__/auth/iframe",qe="emulator/auth/iframe",$e={style:{position:"absolute",top:"-100px",width:"1px",height:"1px"},"aria-hidden":"true",tabindex:"-1"},Ke=new Map([["identitytoolkit.googleapis.com","p"],["staging-identitytoolkit.sandbox.googleapis.com","s"],["test-identitytoolkit.sandbox.googleapis.com","t"]]);function He(t){const e=t.config;y(e.authDomain,t,"auth-domain-config-required");const n=e.emulator?_(e,qe):`https://${t.config.authDomain}/${ze}`,s={apiKey:e.apiKey,appName:t.name,v:r.MF},o=Ke.get(t.config.apiHost);o&&(s.eid=o);const a=t._getFrameworks();return a.length&&(s.fw=a.join(",")),`${n}?${(0,i.Am)(s).slice(1)}`}
/**
 * @license
 * Copyright 2020 Google LLC.
 *
 ...
 * limitations under the License.
 */
class T{constructor(t){this.container=t}getPlatformInfoString(){return this.container.getProviders().map((t=>{if(function(t){const e=t.getComponent();return"VERSION"===(null==e?void 0:e.type)}(t)){const e=t.getImmediate();return`${e.library}/${e.version}`}return null})).filter((t=>t)).join(" ")}}const _="@firebase/app",S="0.9.13",C=new r.Vy("@firebase/app"),k="@firebase/app-compat",A="@firebase/analytics-compat",N="@firebase/analytics",R="@firebase/app-check-compat",D="@firebase/app-check",O="@firebase/auth",P="@firebase/auth-compat",L="@firebase/database",M="@firebase/database-compat",x="@firebase/functions",F="@firebase/functions-compat",U="@firebase/installations",V="@firebase/installations-compat",j="@firebase/messaging",B="@firebase/messaging-compat",z="@firebase/performance",q="@firebase/performance-compat",$="@firebase/remote-config",K="@firebase/remote-config-compat",H="@firebase/storage",G="@firebase/storage-compat",W="@firebase/firestore",Q="@firebase/firestore-compat",X="firebase",J="[DEFAULT]",Y={[_]:"fire-core",[k]:"fire-core-compat",[N]:"fire-analytics",[A]:"fire-analytics-compat",[D]:"fire-app-check",[R]:"fire-app-check-compat",[O]:"fire-auth",[P]:"fire-auth-compat",[L]:"fire-rtdb",[M]:"fire-rtdb-compat",[x]:"fire-fn",[F]:"fire-fn-compat",[U]:"fire-iid",[V]:"fire-iid-compat",[j]:"fire-fcm",[B]:"fire-fcm-compat",[z]:"fire-perf",[q]:"fire-perf-compat",[$]:"fire-rc",[K]:"fire-rc-compat",[H]:"fire-gcs",[G]:"fire-gcs-compat",[W]:"fire-fst",[Q]:"fire-fst-compat","fire-js":"fire-js",[X]:"fire-js-all"},Z=new Map,tt=new Map;function et(t,e){try{t.container.addComponent(e)}catch(n){C.debug(`Component ${e.name} failed to register with FirebaseApp ${t.name}`,n)}}function nt(t){const e=t.name;if(tt.has(e))return C.debug(`There were multiple attempts to register component ${e}.`),!1;tt.set(e,t);for(const e of Z.values())et(e,t);return!0}function it(t,e){const n=t.container.getProvider("heartbeat").getImmediate({optional:!0});return n&&n.triggerHeartbeat(),t.container.getProvider(e)}
/**
 * @license
 * Copyright 2019 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class qi{constructor(t,e){this.user=e,this.type="OAuth",this.headers=new Map,this.headers.set("Authorization",`Bearer ${t}`)}}class $i{getToken(){return Promise.resolve(null)}invalidateToken(){}start(t,e){t.enqueueRetryable((()=>e(Ni.UNAUTHENTICATED)))}shutdown(){}}class Ki{constructor(t){this.token=t,this.changeListener=null}getToken(){return Promise.resolve(this.token)}invalidateToken(){}start(t,e){this.changeListener=e,t.enqueueRetryable((()=>e(this.token.user)))}shutdown(){this.changeListener=null}}class Hi{constructor(t){this.t=t,this.currentUser=Ni.UNAUTHENTICATED,this.i=0,this.forceRefresh=!1,this.auth=null}start(t,e){let n=this.i;const i=t=>this.i!==n?(n=this.i,e(t)):Promise.resolve();let r=new zi;this.o=()=>{this.i++,this.currentUser=this.u(),r.resolve(),r=new zi,t.enqueueRetryable((()=>i(this.currentUser)))};const s=()=>{const e=r;t.enqueueRetryable((async()=>{await e.promise,await i(this.currentUser)}))},o=t=>{Pi("FirebaseAuthCredentialsProvider","Auth detected"),this.auth=t,this.auth.addAuthTokenListener(this.o),s()};this.t.onInit((t=>o(t))),setTimeout((()=>{if(!this.auth){const t=this.t.getImmediate({optional:!0});t?o(t):(Pi("FirebaseAuthCredentialsProvider","Auth not yet detected"),r.resolve(),r=new zi)}}),0),s()}getToken(){const t=this.i,e=this.forceRefresh;return this.forceRefresh=!1,this.auth?this.auth.getToken(e).then((e=>this.i!==t?(Pi("FirebaseAuthCredentialsProvider","getToken aborted due to token change."),this.getToken()):e?(Ui("string"==typeof e.accessToken),new qi(e.accessToken,this.currentUser)):null)):Promise.resolve(null)}invalidateToken(){this.forceRefresh=!0}shutdown(){this.auth&&this.auth.removeAuthTokenListener(this.o)}u(){const t=this.auth&&this.auth.getUid();return Ui(null===t||"string"==typeof t),new Ni(t)}}class Gi{constructor(t,e,n){this.h=t,this.l=e,this.m=n,this.type="FirstParty",this.user=Ni.FIRST_PARTY,this.g=new Map}p(){return this.m?this.m():null}get headers(){this.g.set("X-Goog-AuthUser",this.h);const t=this.p();return t&&this.g.set("Authorization",t),this.l&&this.g.set("X-Goog-Iam-Authorization-Token",this.l),this.g}}class Wi{constructor(t,e,n){this.h=t,this.l=e,this.m=n}getToken(){return Promise.resolve(new Gi(this.h,this.l,this.m))}start(t,e){t.enqueueRetryable((()=>e(Ni.FIRST_PARTY)))}shutdown(){}invalidateToken(){}}class Qi{constructor(t){this.value=t,this.type="AppCheck",this.headers=new Map,t&&t.length>0&&this.headers.set("x-firebase-appcheck",this.value)}}class Xi{constructor(t){this.I=t,this.forceRefresh=!1,this.appCheck=null,this.T=null}start(t,e){const n=t=>{null!=t.error&&Pi("FirebaseAppCheckTokenProvider",`Error getting App Check token; using placeholder token instead. Error: ${t.error.message}`);const n=t.token!==this.T;return this.T=t.token,Pi("FirebaseAppCheckTokenProvider",`Received ${n?"new":"existing"} token.`),n?e(t.token):Promise.resolve()};this.o=e=>{t.enqueueRetryable((()=>n(e)))};const i=t=>{Pi("FirebaseAppCheckTokenProvider","AppCheck detected"),this.appCheck=t,this.appCheck.addTokenListener(this.o)};this.I.onInit((t=>i(t))),setTimeout((()=>{if(!this.appCheck){const t=this.I.getImmediate({optional:!0});t?i(t):Pi("FirebaseAppCheckTokenProvider","AppCheck not yet detected")}}),0)}getToken(){const t=this.forceRefresh;return this.forceRefresh=!1,this.appCheck?this.appCheck.getToken(t).then((t=>t?(Ui("string"==typeof t.token),this.T=t.token,new Qi(t.token)):null)):Promise.resolve(null)}invalidateToken(){this.forceRefresh=!0}shutdown(){this.appCheck&&this.appCheck.removeTokenListener(this.o)}}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class qr{constructor(t,e,n,i,r,s,o,a,c){this.databaseId=t,this.appId=e,this.persistenceKey=n,this.host=i,this.ssl=r,this.forceLongPolling=s,this.autoDetectLongPolling=o,this.longPollingOptions=a,this.useFetchStreams=c}}class $r{constructor(t,e){this.projectId=t,this.database=e||"(default)"}static empty(){return new $r("","")}get isDefaultDatabase(){return"(default)"===this.database}isEqual(t){return t instanceof $r&&t.projectId===this.projectId&&t.database===this.database}}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */!function(t,e=!0){!function(t){Ri=t}(r.MF),(0,r.om)(new s.uA("firestore",((t,{instanceIdentifier:n,options:i})=>{const r=t.getProvider("app").getImmediate(),s=new Rh(new Hi(t.getProvider("auth-internal")),new Xi(t.getProvider("app-check-internal")),function(t,e){if(!Object.prototype.hasOwnProperty.apply(t.options,["projectId"]))throw new Bi(ji.INVALID_ARGUMENT,'"projectId" not provided in firebase.initializeApp.');return new $r(t.options.projectId,e)}(r,n),r);return i=Object.assign({useFetchStreams:e},i),s._setSettings(i),s}),"PUBLIC").setMultipleInstances(!0)),(0,r.KO)(Ai,"3.13.0",t),(0,r.KO)(Ai,"3.13.0","esm2017")}()}},s={};function o(t){var e=s[t];if(void 0!==e)return e.exports;var n=s[t]={exports:{}};return r[t](n,n.exports,o),n.exports}o.d=function(t,e){for(var n in e)o.o(e,n)&&!o.o(t,n)&&Object.defineProperty(t,n,{enumerable:!0,get:e[n]})},o.g=function(){if("object"==typeof globalThis)return globalThis;try{return this||new Function("return this")()}catch(t){if("object"==typeof window)return window}}(),o.o=function(t,e){return Object.prototype.hasOwnProperty.call(t,e)},t=o(4026),e=o(6582),n=function(t,e,n,i){return new(n||(n=Promise))((function(r,s){function o(t){try{c(i.next(t))}catch(t){s(t)}}function a(t){try{c(i.throw(t))}catch(t){s(t)}}function c(t){var e;t.done?r(t.value):(e=t.value,e instanceof n?e:new n((function(t){t(e)}))).then(o,a)}c((i=i.apply(t,e||[])).next())}))},i=function(t,e){var n,i,r,s,o={label:0,sent:function(){if(1&r[0])throw r[1];return r[1]},trys:[],ops:[]};return s={next:a(0),throw:a(1),return:a(2)},"function"==typeof Symbol&&(s[Symbol.iterator]=function(){return this}),s;function a(a){return function(c){return function(a){if(n)throw new TypeError("Generator is already executing.");for(;s&&(s=0,a[0]&&(o=0)),o;)try{if(n=1,i&&(r=2&a[0]?i.return:a[0]?i.throw||((r=i.return)&&r.call(i),0):i.next)&&!(r=r.call(i,a[1])).done)return r;switch(i=0,r&&(a=[2&a[0],r.value]),a[0]){case 0:case 1:r=a;break;case 4:return o.label++,{value:a[1],done:!1};case 5:o.label++,i=a[1],a=[0];continue;case 7:a=o.ops.pop(),o.trys.pop();continue;default:if(!((r=(r=o.trys).length>0&&r[r.length-1])||6!==a[0]&&2!==a[0])){o=0;continue}if(3===a[0]&&(!r||a[1]>r[0]&&a[1]<r[3])){o.label=a[1];break}if(6===a[0]&&o.label<r[1]){o.label=r[1],r=a;break}if(r&&o.label<r[2]){o.label=r[2],o.ops.push(a);break}r[2]&&o.ops.pop(),o.trys.pop();continue}a=e.call(t,o)}catch(t){a=[6,t],i=0}finally{n=r=0}if(5&a[0])throw a[1];return{value:a[0]?a[1]:void 0,done:!0}}([a,c])}}},console.info("[loadSidebar.ts]: Loading Sidebar..."),document.querySelector(".p-4").style.display="none",e.j.onAuthStateChanged((function(r){var s,o,a;if(/Chrome/.test(navigator.userAgent)&&/Google Inc/.test(navigator.vendor)&&navigator.userAgent.includes("Chrome")&&(null!==(s=navigator.userAgent.match(/Chrome\/(\d{3})/))&&void 0!==s?s:[])[1]&&parseInt((null!==(o=navigator.userAgent.match(/Chrome\/(\d{3})/))&&void 0!==o?o:[])[1])<107){if(navigator.userAgent.includes("Chrome"))return void(window.location.href="/category/infomation/unsupported-browser.html")}else if(Number.isNaN(parseInt((null!==(a=navigator.userAgent.match(/Chrome\/(\d{3})/))&&void 0!==a?a:[])[1]))&&navigator.userAgent.includes("Chrome"))return void(window.location.href="/category/infomation/unsupported-browser.html");if(/MSIE \d|Trident.*rv:/.test(navigator.userAgent))window.location.href="/category/infomation/unsupported-browser.html";else{if(null===r){console.log("[loadSidebar.ts] User is not signed in");var c=new XMLHttpRequest;return c.open("GET","/auth/panel/sidebar.html",!0),c.onreadystatechange=function(){return n(this,void 0,void 0,(function(){var t,e;return i(this,(function(n){return 4===c.readyState&&200===c.status&&(t=c.responseText,null!==(e=document.querySelector("#settings-sidebar"))&&(e.innerHTML=t),e.style.pointerEvents="none",e.style.opacity="0.5",console.info("[loadSidebar.ts] Sidebar loaded"),document.querySelector(".p-4").style.display=""),[2]}))}))},void c.send()}if(null!==r){console.log(r.uid),window.localStorage.setItem("userId",r.uid);var u=document.getElementById("signup"),h=document.getElementById("signin"),l=document.getElementById("panel"),d=document.getElementById("logout");if(null==u||null==h||null==l||null==d)return;console.log("payphone"),u.classList.add("is-hidden"),h.classList.add("is-hidden"),l.classList.remove("is-hidden"),d.classList.remove("is-hidden"),d.addEventListener("click",(function(){e.j.signOut(),window.localStorage.removeItem("userId"),window.location.reload()})),document.body.style.display="block"}else document.body.style.display="block";var f=new XMLHttpRequest;f.open("GET","/auth/panel/sidebar.html",!0),f.onreadystatechange=function(){return n(this,void 0,void 0,(function(){var n,s,o,a,c,u;return i(this,(function(i){switch(i.label){case 0:return 4!==f.readyState||200!==f.status?[3,2]:(n=f.responseText,null!==(s=document.querySelector("#settings-sidebar"))&&(s.innerHTML=n),console.info("[loadSidebar.ts] Sidebar loaded"),o=document.getElementById("premiumUpgradeUpsell_Text"),document.getElementById("premiumUpgradeUpsell_Container"),a=document.getElementById("premiumUpgradeUpsell_Button"),[4,(0,t.x7)((0,t.H9)(e.k,"subscription-state",r.uid))]);case 1:if(c=i.sent(),u=c.data(),!c.exists())return document.querySelector(".p-4").style.display="",[2];switch(u.lastChecked+6048e5<Date.now()&&"free"!==u.plan&&!u.isStudent&&(u.isExpired=!0,u.plan="free",(0,t.BN)((0,t.H9)(e.k,"subscription-state",r.uid),u)),u.lastChecked+31556952e3<Date.now()&&u.isStudent&&(u.isExpired=!0,u.plan="free",(0,t.BN)((0,t.H9)(e.k,"subscription-state",r.uid),u)),u.plan){case"premiumplus":o.textContent="プレミアムプラスへアップグレードしていただき、ありがとうございます。最高級プランをお楽しみください。",a.classList.add("is-hidden");break;case"premium":o.textContent="プレミアムプラスにアップグレードすると、メッセージが強調表示されたり、実験中の機能を利用できます。",a.innerHTML='<i class="fas fa-money-bill"></i>アップグレード'}u.isStudent&&(o.textContent="あなたは、プレミアムプラスを無料で利用する資格を持っています。学生の間、無料です。",a.classList.add("is-hidden")),u.isExpired&&(o.textContent="あなたのプランを再確認する必要があります。サブスクリプションを終了した場合はもう一度決済し、雷へ連絡すると継続できます。",a.classList.remove("is-hidden"),a.textContent="サブスクリプションについて",u.id.startsWith("student-")&&(o.innerHTML='あなたが学生であることを再確認する必要があります。再確認するまで、一時的にプレミアムの特典は利用できなくなります。<br>もう学生ではありませんか？<a href="/auth/panel/subscriptions.html">こちら</a>をクリックしてプレミアムへアップグレードしてください。',a.textContent="学生確認へ",a.href="/student/")),document.querySelector(".p-4").style.display="",i.label=2;case 2:return[2]}}))}))},f.send()}}))}();