 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Wt=new T(3e4,6e4);function Gt(){const e=ct().___jsl;if(null==e?void 0:e.H)for(const t of Object.keys(e.H))if(e.H[t].r=e.H[t].r||[],e.H[t].L=e.H[t].L||[],e.H[t].r=[...e.H[t].L],e.CP)for(let t=0;t<e.CP.length;t++)e.CP[t]=null}function qt(e){return new Promise(((t,n)=>{var i,r,s;function o(){Gt(),gapi.load("gapi.iframes",{callback:()=>{t(gapi.iframes.getContext())},ontimeout:()=>{Gt(),n(p(e,"network-request-failed"))},timeout:Wt.get()})}if(null===(r=null===(i=ct().gapi)||void 0===i?void 0:i.iframes)||void 0===r?void 0:r.Iframe)t(gapi.iframes.getContext());else{if(!(null===(s=ct().gapi)||void 0===s?void 0:s.load)){const t=Ee("iframefcb");return ct()[t]=()=>{gapi.load?o():n(p(e,"network-request-failed"))},_e(`${be.gapiScript}?onload=${t}`).catch((e=>n(e)))}o()}})).catch((e=>{throw Xt=null,e}))}let Xt=null;
/**
 * @license
 * Copyright 2020 Google LLC.
 *
