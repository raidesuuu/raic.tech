(()=>{"use strict";var e={6743:(e,t,n)=>{n.d(t,{$L:()=>x,$g:()=>k,A4:()=>d,Am:()=>H,As:()=>L,Cv:()=>F,FA:()=>D,Fy:()=>b,Hk:()=>r,I9:()=>K,Im:()=>j,K3:()=>a,KA:()=>l,Ku:()=>te,OE:()=>ee,T9:()=>y,Tj:()=>m,Uj:()=>h,XA:()=>v,ZQ:()=>E,bD:()=>z,cY:()=>w,dI:()=>X,eX:()=>R,g:()=>P,gR:()=>V,gz:()=>G,hp:()=>W,jZ:()=>I,kH:()=>B,kj:()=>Z,lT:()=>S,lV:()=>C,nr:()=>A,qc:()=>U,sr:()=>T,tD:()=>Q,u:()=>u,vA:()=>s,yU:()=>_,yw:()=>q,zW:()=>N});
/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Im{constructor(e,t){if(!isFinite(e)||e<-90||e>90)throw new gl(pl.INVALID_ARGUMENT,"Latitude must be a number between -90 and 90, but was: "+e);if(!isFinite(t)||t<-180||t>180)throw new gl(pl.INVALID_ARGUMENT,"Longitude must be a number between -180 and 180, but was: "+t);this._lat=e,this._long=t}get latitude(){return this._lat}get longitude(){return this._long}isEqual(e){return this._lat===e._lat&&this._long===e._long}toJSON(){return{latitude:this._lat,longitude:this._long}}_compareTo(e){return kl(this._lat,e._lat)||kl(this._long,e._long)}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function b_(e,t){return e.tenantId&&!t.tenantId?Object.assign(Object.assign({},t),{tenantId:e.tenantId}):t}async function E_(e,t,n,s,r={}){return I_(e,r,(async()=>{let r={},o={};s&&("GET"===t?o=s:r={body:JSON.stringify(s)});const a=(0,i.Am)(Object.assign({key:e.config.apiKey},o)).slice(1),c=await e._getAdditionalHeaders();return c["Content-Type"]="application/json",e.languageCode&&(c["X-Firebase-Locale"]=e.languageCode),y_.fetch()(C_(e,e.config.apiHost,n,a),Object.assign({method:t,headers:c,referrerPolicy:"no-referrer"},r))}))}async function I_(e,t,n){e._canInitEmulator=!1;const s=Object.assign(Object.assign({},v_),t);try{const t=new k_(e),i=await Promise.race([n(),t.promise]);t.clearNetworkTimeout();const r=await i.json();if("needConfirmation"in r)throw A_(e,"account-exists-with-different-credential",r);if(i.ok&&!("errorMessage"in r))return r;{const t=i.ok?r.errorMessage:r.error.message,[n,o]=t.split(" : ");if("FEDERATED_USER_ID_ALREADY_LINKED"===n)throw A_(e,"credential-already-in-use",r);if("EMAIL_EXISTS"===n)throw A_(e,"email-already-in-use",r);if("USER_DISABLED"===n)throw A_(e,"user-disabled",r);const a=s[n]||n.toLowerCase().replace(/[_\s]+/g,"-");if(o)throw c_(e,a,o);o_(e,a)}}catch(t){if(t instanceof i.g)throw t;o_(e,"network-request-failed",{message:String(t)})}}async function T_(e,t,n,i,s={}){const r=await E_(e,t,n,i,s);return"mfaPendingCredential"in r&&o_(e,"multi-factor-auth-required",{_serverResponse:r}),r}function C_(e,t,n,i){const s=`${t}${n}?${i}`;return e.config.emulator?__(e.config,s):`${e.config.apiScheme}://${s}`}function S_(e){switch(e){case"ENFORCE":return"ENFORCE";case"AUDIT":return"AUDIT";case"OFF":return"OFF";default:return"ENFORCEMENT_STATE_UNSPECIFIED"}}class k_{constructor(e){this.auth=e,this.timer=null,this.promise=new Promise(((e,t)=>{this.timer=setTimeout((()=>t(a_(this.auth,"network-request-failed"))),w_.get())}))}clearNetworkTimeout(){clearTimeout(this.timer)}}function A_(e,t,n){const i={appName:e.name};n.email&&(i.email=n.email),n.phoneNumber&&(i.phoneNumber=n.phoneNumber);const s=a_(e,t,i);return s.customData._tokenResponse=n,s}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Iy(e,t){return T_(e,"POST","/v1/accounts:signInWithIdp",b_(e,t))}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * limitations under the License.
 */
function(t,n){const s=(0,e.j6)(t,"auth");if(s.isInitialized()){const e=s.getImmediate(),t=s.getOptions();if((0,i.bD)(t,null!=n?n:{}))return e;o_(e,"already-initialized")}return s.initialize({options:n})}(t,{popupRedirectResolver:Zv,persistence:[cv,Hy,Wy]}),r=(0,i.XA)("authTokenSyncURL");if(r&&r.match(/^\/[^\/].*/)){const e=(o=r,async e=>{const t=e&&await e.getIdTokenResult(),n=t&&((new Date).getTime()-Date.parse(t.issuedAtTime))/1e3;if(n&&n>iw)return;const i=null==t?void 0:t.token;sw!==i&&(sw=i,await fetch(o,{method:i?"POST":"DELETE",headers:i?{Authorization:`Bearer ${i}`}:{}}))});!function(e,t,n){(0,i.Ku)(e).beforeAuthStateChanged(t,n)}(s,e,(()=>e(s.currentUser))),function(e,t,n,s){(0,i.Ku)(e).onIdTokenChanged(t,n,s)}(s,(t=>e(t)))}var o;const a=(0,i.Tj)("auth");return a&&my(s,`http://${a}`),s}(),bw=function(t=(0,e.Sx)(),n){const s=(0,e.j6)(t,"database").getImmediate({identifier:n});if(!s._instanceStarted){const e=(0,i.yU)("database");e&&function(e,t,n,s={}){e=(0,i.Ku)(e),e._checkNotDeleted("useEmulator"),e._instanceStarted&&T("Cannot call useEmulator() after instance has already been initialized.");const r=e._repoInternal;let o;if(r.repoInfo_.nodeAdmin)s.mockUserToken&&T('mockUserToken is not supported by the Admin SDK. For client access with mock users, please use the "firebase" package instead of "firebase-admin".'),o=new B(B.OWNER);else if(s.mockUserToken){const t="string"==typeof s.mockUserToken?s.mockUserToken:(0,i.Fy)(s.mockUserToken,e.app.options.projectId);o=new B(t)}!function(e,t,n,i){e.repoInfo_=new G(`${t}:${n}`,!1,e.repoInfo_.namespace,e.repoInfo_.webSocketOnly,e.repoInfo_.nodeAdmin,e.repoInfo_.persistenceKey,e.repoInfo_.includeNamespaceInQueryParams,!0),i&&(e.authTokenProvider_=i)}(r,t,n,o)}(s,...e)}return s}(),Ew=function(t,n){const s="object"==typeof t?t:(0,e.Sx)(),r="string"==typeof t?t:n||"(default)",o=(0,e.j6)(s,"firestore").getImmediate({identifier:r});if(!o._initialized){const e=(0,i.yU)("firestore");e&&function(e,t,n,s={}){var r;const o=(e=lm(e,um))._getSettings(),a=`${t}:${n}`;if("firestore.googleapis.com"!==o.host&&o.host!==a&&ll("Host has been set in both settings() and connectFirestoreEmulator(), emulator host will be used."),e._setSettings(Object.assign(Object.assign({},o),{host:a,ssl:!1})),s.mockUserToken){let t,n;if("string"==typeof s.mockUserToken)t=s.mockUserToken,n=il.MOCK_USER;else{t=(0,i.Fy)(s.mockUserToken,null===(r=e._app)||void 0===r?void 0:r.options.projectId);const o=s.mockUserToken.sub||s.mockUserToken.user_id;if(!o)throw new gl(pl.INVALID_ARGUMENT,"mockUserToken must contain 'sub' or 'user_id' field!");n=new il(o)}e._authCredentials=new vl(new _l(t,n))}}(o,...e)}return o}();null===window.localStorage.getItem("raichat-settings-available")&&(window.localStorage.setItem("raichat-settings-available","true"),window.localStorage.setItem("raichat-markdown","true"),window.localStorage.setItem("raichat-ngwords",JSON.stringify(["死ね"]))),void 0===window.localStorage.getItem("raichat-hide-checkmark")&&window.localStorage.setItem("raichat-hide-checkmark","false");var Iw=window.localStorage.getItem("raichat-markdown"),Tw=window.localStorage.getItem("raichat-hide-checkmark");setTimeout((function(){yw=0}),15e3);var Cw=setInterval((function(){var e=document.getElementById("app-loading-text");null!==e&&("Rai Chatをロード中"===e.textContent?e.textContent="Rai Chatをロード中.":"Rai Chatをロード中."===e.textContent?e.textContent="Rai Chatをロード中..":"Rai Chatをロード中.."===e.textContent?e.textContent="Rai Chatをロード中...":"Rai Chatをロード中..."===e.textContent&&(e.textContent="Rai Chatをロード中"))}),300);function Sw(e){return"free"!=e.paid&&1==e.verified&&"false"===e.checkmarkState}function kw(e,t){var n=document.getElementById("app-message-dialog"),i=document.getElementById("app-message-dialog-content"),s=document.getElementById("app-message-dialog-title"),r=document.getElementById("app-message-dialog-description"),o=document.getElementById("app-message-dialog-button"),a=document.getElementById("app-message-dialog-close");null!==n&&null!==i&&null!==s&&null!==r&&null!==o&&null!==a&&(i.classList.add("is-active"),s.innerHTML=e,r.innerHTML=t,o.classList.add("is-hidden"),a.textContent="閉じる",n.showModal())}uw.style.display="none",dw.classList.remove("is-hidden"),null===(ow=document.querySelector("body"))||void 0===ow||ow.addEventListener("click",(function(e){return lw(this,void 0,void 0,(function(){var t,n,i,s,r,o,a,c,l,h,u,d,f,p,g,m,_,y,v,w,b,E,I,T,C,S,k=this;return hw(this,(function(A){switch(A.label){case 0:return e.target instanceof HTMLAnchorElement?"raic.tech"==e.target.hostname||"10.249.176.251"==e.target.hostname||"www.patreon.com"==e.target.hostname||"javascript:void(0)"===e.target.href||""===e.target.href?[2]:(e.preventDefault(),e.target.href.includes("javascript:")?e.target.href.includes("javascript:void(0)")?[2]:[4,kw("リンクに関しての注意","悪意のあるリンクを開こうとしました。このリンクは、UpLauncherのサイト外です。\nWebは便利ですが、危険なリンクもあります。")]:[3,2]):[3,4];case 1:return A.sent(),[2];case 2:return[4,Aw("リンクに関しての注意","リンクを開きますか？このリンクは、UpLauncherのサイト外です。\nWebは便利ですが、このリンクは危険な可能性もあります。(新しいタブで開きます)")];case 3:A.sent()&&window.open(e.target.href,"_blank"),A.label=4;case 4:return e.target instanceof HTMLElement?e.target.classList.contains("remove")?(t=null===(u=null===(h=null===(l=e.target.parentElement)||void 0===l?void 0:l.parentElement)||void 0===h?void 0:h.parentElement)||void 0===u?void 0:u.getAttribute("data-messageId"))?[4,Aw("メッセージ","このメッセージを削除しますか？").then((function(n){var i,s,r;n&&(Cs(Is(bw,"messages/"+t),null),e.target instanceof HTMLElement&&(null===(r=null===(s=null===(i=e.target.parentElement)||void 0===i?void 0:i.parentElement)||void 0===s?void 0:s.parentElement)||void 0===r||r.remove()))}))]:[3,6]:[3,7]:[3,9];case 5:A.sent(),A.label=6;case 6:return[3,9];case 7:return e.target.classList.contains("report")?(n=null===(p=null===(f=null===(d=e.target.parentElement)||void 0===d?void 0:d.parentElement)||void 0===f?void 0:f.parentElement)||void 0===p?void 0:p.getAttribute("data-messageId"),i=document.getElementsByTagName("body")[0].dataset.user,n?[4,Nw().then((function(e){return lw(k,void 0,void 0,(function(){return hw(this,(function(t){switch(t.label){case 0:return"false"==e?[3,2]:[4,Ym(gm(Ew,"raichat-report",n,"user",i||"abc"),{type:JSON.parse(e).type,message:JSON.parse(e).message}).then((function(){kw("メッセージを報告","このメッセージの報告が完了しました。<br>Rai Chatを貢献してくださり、ありがとうございます。<br><h2>注意事項</h2><ul><li>・メッセージは1回しか報告できません。</li><li>・BANされるまでに時間がかかります。</li><li>・BANされてもされなくてもお知らせはされません。</li></ul>")}))];case 1:return t.sent(),[3,3];case 2:console.log(e),t.label=3;case 3:return[2]}}))}))}))]:[3,9]):[3,9];case 8:A.sent(),A.label=9;case 9:return"owner"!=_w?[3,14]:e.target instanceof HTMLElement?e.target.classList.contains("ban")?(s=null===(_=null===(m=null===(g=e.target.parentElement)||void 0===g?void 0:g.parentElement)||void 0===m?void 0:m.parentElement)||void 0===_?void 0:_.getAttribute("data-userId"))?[4,Aw("ユーザー","このユーザーをBANしますか？").then((function(e){e&&Gm(gm(Ew,"raichat-user-status",s)).then((function(e){return lw(k,void 0,void 0,(function(){return hw(this,(function(t){return e.exists()&&Ym(gm(Ew,"raichat-user-status",s),{username:e.data().username,checkmarkState:e.data().checkmarkState,paid:e.data().paid,banned:!0}),[2]}))}))}))}))]:[3,11]:[3,12]:[3,14];case 10:A.sent(),A.label=11;case 11:return[3,14];case 12:return e.target.classList.contains("remove-manually")&&(r=null===(w=null===(v=null===(y=e.target.parentElement)||void 0===y?void 0:y.parentElement)||void 0===v?void 0:v.parentElement)||void 0===w?void 0:w.getAttribute("data-messageId"))?[4,Aw("メッセージ",'このメッセージを"不適切"ラベル付きで削除しますか？').then((function(t){t?Ss(Ts(Is(bw),"messages/"+r)).then((function(t){return lw(k,void 0,void 0,(function(){var n,i,s;return hw(this,(function(o){return Cs(Is(bw,"messages/"+r),{username:"Rai Chat System",paid:"free",uid:"system",id:t.val().id,time:t.val().time,isSystemMessage:!0,message:"このメッセージはUpLauncherの管理者によって削除されました。",favorite:0}),e.target instanceof HTMLElement&&(null===(s=null===(i=null===(n=e.target.parentElement)||void 0===n?void 0:n.parentElement)||void 0===i?void 0:i.parentElement)||void 0===s||s.remove()),[2]}))}))})):console.log(t)}))]:[3,14];case 13:A.sent(),A.label=14;case 14:return e.target instanceof HTMLElement&&(e.target.classList.contains("favorite")&&(o=null===(I=null===(E=null===(b=e.target.parentElement)||void 0===b?void 0:b.parentElement)||void 0===E?void 0:E.parentElement)||void 0===I?void 0:I.getAttribute("data-messageId")))?(a=Is(bw),c=document.getElementsByTagName("body")[0].dataset.user,(null===(S=null===(C=null===(T=e.target.parentElement)||void 0===T?void 0:T.parentElement)||void 0===C?void 0:C.parentElement)||void 0===S?void 0:S.querySelector(".system"))?(kw("メッセージ",'<i class="far fa-shield color-red"></i>このメッセージはシステムメッセージのため、いいねできません。'),[2]):[4,Gm(gm(Ew,"raichat-message-status",o,c||"null","data")).then((function(t){return lw(k,void 0,void 0,(function(){var n=this;return hw(this,(function(i){if(t.exists()){if(t.data().isFavorited)return Ss(Ts(a,"messages/"+o)).then((function(t){return lw(n,void 0,void 0,(function(){var n,i,s,r;return hw(this,(function(a){switch(a.label){case 0:return Cs(Is(bw,"messages/"+o),{username:t.val().username,paid:t.val().paid,uid:t.val().uid,id:t.val().id,time:t.val().time,message:t.val().message,favorite:t.val().favorite?t.val().favorite-1:0}),e.target instanceof HTMLElement&&(n=null===(r=null===(s=null===(i=e.target.parentElement)||void 0===i?void 0:i.parentElement)||void 0===s?void 0:s.parentElement)||void 0===r?void 0:r.querySelector(".favoriteText"))&&(n.textContent=String(t.val().favorite?t.val().favorite-1:0)),[4,Jm(gm(Ew,"raichat-message-status",o,c||"null","data"))];case 1:return a.sent(),[2]}}))}))})),[2]}else Ss(Ts(a,"messages/"+o)).then((function(t){return lw(n,void 0,void 0,(function(){var n,i,s,r;return hw(this,(function(a){switch(a.label){case 0:return Cs(Is(bw,"messages/"+o),{username:t.val().username,paid:t.val().paid,uid:t.val().uid,id:t.val().id,time:t.val().time,message:t.val().message,favorite:t.val().favorite?t.val().favorite+1:1}),e.target instanceof HTMLElement&&(n=null===(r=null===(s=null===(i=e.target.parentElement)||void 0===i?void 0:i.parentElement)||void 0===s?void 0:s.parentElement)||void 0===r?void 0:r.querySelector(".favoriteText"))&&(n.textContent=t.val().favorite?t.val().favorite+1:1),[4,Ym(gm(Ew,"raichat-message-status",o,c||"null","data"),{isFavorited:!0})];case 1:return a.sent(),[2]}}))}))}));return[2]}))}))}))]):[3,16];case 15:A.sent(),A.label=16;case 16:return e.target instanceof HTMLElement&&(e.target.classList.contains("verified")?kw("認証されたユーザー",'<i class="fas fa-check color-blue"></i>このユーザーはStandard以上のプランを購入していて、本人であることが確認されているため認証されています。<a href="/chat/docs/verified.html" target="_blank" noreferrer noopener>詳細はこちら。</a>'):e.target.classList.contains("owner")?kw("認証されたユーザー",'<i class="fas fa-screwdriver-wrench color-gold"></i>このユーザーはUpLauncherの管理者であるため、認証されています。<a href="/chat/docs/verified.html" target="_blank" noreferrer noopener>詳細はこちら。</a>'):e.target.classList.contains("student")?kw("認証されたユーザー",'<i class="fas fa-user color-green"></i>このユーザーは学生のため、認証されています。<a href="/chat/docs/verified.html" target="_blank" noreferrer noopener>詳細はこちら。</a>'):e.target.classList.contains("system")&&kw("認証されたユーザー",'<i class="far fa-shield color-red"></i>このメッセージはRai Chatのシステムからのメッセージです。<a href="/chat/docs/verified.html" target="_blank" noreferrer noopener>詳細はこちら。</a>')),[2]}}))}))})),function(e,t,n,s){(0,i.Ku)(e).onAuthStateChanged(t,n,s)}(ww,(function(e){return lw(void 0,void 0,void 0,(function(){var t,n,i;return hw(this,(function(s){switch(s.label){case 0:return null===e?(window.location.href="/auth/signin.html",[2]):null===pw?(console.log("[NullCheck]: #timeline is null"),[2]):(document.getElementsByTagName("body")[0].dataset.user=e.uid,[4,Gm(gm(Ew,"patreonlinkstatus",e.uid))]);case 1:return(t=s.sent()).exists()&&(_w=t.data().plan,vw=t.data().isStudent),[4,Gm(gm(Ew,"raichat-user-status",e.uid))];case 2:return!1!==(n=s.sent()).exists()?[3,4]:[4,Ym(gm(Ew,"raichat-user-status",null==e?void 0:e.uid),{banned:!1})];case 3:return s.sent(),[3,6];case 4:return[4,Ym(gm(Ew,"raichat-user-status",null==e?void 0:e.uid),{username:e.displayName,checkmarkState:Tw,verified:!!n.data().verified&&n.data().verified,paid:_w,isStudent:vw,banned:n.data().banned})];case 5:s.sent(),1==n.data().banned&&(window.location.href="/chat/app/banned.html"),s.label=6;case 6:return i=Is(bw,"messages/"),fw.addEventListener("click",(function(){!function(e,t){lw(this,void 0,void 0,(function(){var n,i,s,r,o;return hw(this,(function(a){switch(a.label){case 0:return n=["死ね","殺す","殺害","アホ","バカ","カス","ころす","しね","あほ","アダルト","エロ","うんこ","まんこ","ちんこ","セックス","sex","fuck","マン凸","チン凸","pornhub.com","xvideos.com"],null===t||null===gw?[2]:""===e?(gw.classList.remove("is-hidden"),gw.textContent="メッセージを入力してください",[2]):[4,Gm(gm(Ew,"raichat-user-status",t.uid))];case 1:return(i=a.sent()).exists()&&1==i.data().banned&&(window.location.href="/chat/app/banned.html"),e.length>100?(gw.classList.remove("is-hidden"),gw.textContent="メッセージは100文字以内で入力してください",[2]):n.some((function(t){return e.includes(t)}))||n.some((function(e){var n;return null===(n=t.displayName)||void 0===n?void 0:n.includes(e)}))||"Rai Chat System"===t.displayName?(gw.classList.remove("is-hidden"),gw.textContent="NGワードが含まれているか、使用できない名前が含まれています。","owner"==_w?[3,3]:(s=Date.now(),Cs(Is(bw,"messages/"+s+"-"+t.uid),{username:t.displayName,paid:Tw?"free":vw?"student":_w,verified:!1,uid:t.uid,id:s+"-"+t.uid,isSystemMessage:!0,time:(new Date).toLocaleString(),message:"このメッセージの内容は、Rai Chatの利用規約に違反しています。",favorite:0}).then((function(){yw++})),[4,Ym(gm(Ew,"raichat-user-status",null==t?void 0:t.uid),{banned:!0})])):[3,5];case 2:return a.sent(),window.location.reload(),[3,4];case 3:gw.textContent="NGワードが含まれていますが、オーナー権限がアクティブなためBANされません。",a.label=4;case 4:return[2];case 5:return yw>=3?(gw.classList.remove("is-hidden"),gw.textContent="連続でメッセージを送信することはできません",[2]):(r=Date.now(),[4,Gm(gm(Ew,"raichat-user-status",t.uid))]);case 6:return o=a.sent(),Cs(Is(bw,"messages/"+r+"-"+t.uid),{username:t.displayName,paid:Tw?"free":vw?"student":_w,verified:!!o.exists()&&o.data().verified,uid:t.uid,id:r+"-"+t.uid,time:(new Date).toLocaleString(),message:e,favorite:0}).then((function(){yw++})),[2]}}))}))}(document.getElementById("app-message").value,e)})),0,function(e,t,n,i){Ns(e,"child_added",t,n,i)}(i,(function(t){return lw(void 0,void 0,void 0,(function(){var n,i,s,r,o,a;return hw(this,(function(c){switch(c.label){case 0:return n=t.val(),(i=document.createElement("li")).setAttribute("data-messageId",n.id||"undefined"),i.setAttribute("data-userId",n.uid||"undefined"),i.classList.add((null==e?void 0:e.displayName)===n.username?"sent":"receive"),s=document.createElement("span"),r=(r=(r=(r=(r=(r=(r=n.message).replace(/&/g,"&amp;")).replace(/"/g,"&quot;")).replace(/'/g,"&#x27;")).replace(/</g,"&lt;")).replace(/>/g,"&gt;")).replace(/\n/g,"<br>"),"true"===Iw&&(r=function(e){var t=/(\b(https?|ftp|file):\/\/[-A-Z0-9+&@#\/%?=~_|!:,.;]*[-A-Z0-9+&@#\/%=~_|])/gi;return e.includes("[url]")||e.includes("img")?e:e.replace(t,"<i class='far fa-globe'></i><a target='_blank' href='$1'>$1</a>")}(r=(r=(r=(r=(r=(r=(r=(r=(r=(r=r.replace(/\[b\]/g,"<b>")).replace(/\[\/b\]/g,"</b>")).replace(/\[i\]/g,"<i>")).replace(/\[\/i\]/g,"</i>")).replace(/\[u\]/g,"<u>")).replace(/\[\/u\]/g,"</u>")).replace(/\[s\]/g,"<s>")).replace(/\[\/s\]/g,"</s>")).replace(/\[icon\]/g,'<i class="fas fa-')).replace(/\[\/icon\]/g,'"></i>')),r=(r=r.replace(/\[url\]/g,'<a href="')).replace(/\[\/url\]/g,'"><i style="color: white;" class="far fa-globe"></i>URL</a>'),"free"!=n.paid&&(r=(r=(r=(r=r.replace(/\[img\]/g,'<br><img src="')).replace(/\[\/img\]/g,'" onload="this.width=500;this.onload=null;">')).replace(/\[color=#([0-9a-fA-F]{6})\]/g,'<span style="color: #$1 !important">')).replace(/\[\/color\]/g,"</span>"))),[4,Gm(gm(Ew,"raichat-user-status",n.uid))];case 1:return!0===(o=c.sent()).exists()&&(a=o.data(),1==o.data().banned?s.innerHTML='<span>Rai Chat System <i class="far fa-shield system color-red"></i> '.concat(n.time,")").concat("owner"==_w?'&nbsp;<i class="far fa-hammer remove-manually color-gold mr1px"></i> <i class="far fa-xmark remove color-gold"></i> ':"",': BANされているユーザーからのメッセージです。<a href="/chat/docs/tos.html" target="_blank" noreferrer noopener>利用規約。</a></span>'):(i.classList.add(Sw(a)?"owner"==a.paid?"owner":a.isStudent?"student":"verified":"free"),s.innerHTML="<span>".concat(a.username," ").concat(Sw(a)?"owner"==a.paid?'<i class="fas fa-screwdriver-wrench owner color-gold"></i>':a.isStudent?'<i class="fas fa-user student color-green"></i>':'<i class="fas fa-check verified color-blue"></i>':"").concat(n.isSystemMessage?'<i class="far fa-shield system color-red"></i>':"","(").concat(n.time,")").concat("owner"==_w?'&nbsp;<i class="far fa-ban ban color-red mr1px"></i> <i class="far fa-hammer remove-manually color-gold mr1px"></i> <i class="far fa-xmark remove color-gold"></i> ':""," ").concat(n.uid==e.uid?'<i class="far fa-xmark remove color-red"></i>':"",'<i class="far fa-flag color-red report mr1px"></i> <i class="far fa-heart favorite color-red"></i> <span class="favoriteText">').concat(n.favorite,"</span>: ").concat(r,"</span>"))),i.appendChild(s),pw.insertBefore(i,pw.firstChild),uw.style.display="",dw.classList.add("is-hidden"),clearInterval(Cw),[2]}}))}))})),[2]}}))}))})),null===(aw=document.getElementById("searchInput"))||void 0===aw||aw.addEventListener("keyup",(function(){var e,t,n,i=this.value.toLowerCase(),s=null===(e=document.getElementById("app-timeline"))||void 0===e?void 0:e.getElementsByTagName("li");if(null!=s){var r=i.includes(" [premium]"),o=i.includes(" [student]");r&&(i=i.replace(" [premium]","")),o&&(i=i.replace(" [student]",""));for(var a=0;a<s.length;a++){if(null===s[a])return;null==mw||mw.classList.add("is-hidden");var c=null===(n=null===(t=s[a])||void 0===t?void 0:t.textContent)||void 0===n?void 0:n.toLowerCase();null==c||c.replace(/\&lt;/g,""),null==c||c.replace(/\&gt;/g,""),c&&c.indexOf(i)>-1?r?s[a].classList.contains("verified")||s[a].classList.contains("owner")?s[a].style.display="":s[a].style.display="none":o?s[a].classList.contains("student")?s[a].style.display="":s[a].style.display="none":(s[a].style.display="",null==mw||mw.classList.add("is-hidden")):(s[a].style.display="none",null==mw||mw.classList.remove("is-hidden"))}}}));var Aw=function(e,t){return new Promise((function(n){var i=document.getElementById("app-message-dialog"),s=document.getElementById("app-message-dialog-content"),r=document.getElementById("app-message-dialog-title"),o=document.getElementById("app-message-dialog-description"),a=document.getElementById("app-message-dialog-button"),c=document.getElementById("app-message-dialog-close");if(null===i||null===s||null===r||null===o||null===a||null===c)return console.log("Error: Element is null"),console.log("messageAlertDialog:",i),console.log("dialogContent:",s),console.log("dialogTitle:",r),console.log("dialogDescription:",o),console.log("confirmButton:",a),console.log("cancelButton:",c),void n(!1);s.classList.add("is-active"),r.innerHTML=e,o.innerHTML=t,a.classList.remove("is-hidden"),c.textContent="キャンセル",i.showModal(),a.addEventListener("click",(function(){i.close(),n(!0)})),c.addEventListener("click",(function(){i.close(),n(!1)}))}))},Nw=function(){return new Promise((function(e){var t=document.getElementById("app-report-dialog"),n=document.getElementById("app-report-dialog-content"),i=document.getElementById("app-report-dialog-title"),s=document.getElementById("app-report-dialog-description"),r=document.getElementById("app-report-dialog-button"),o=document.getElementById("app-report-dialog-close"),a=document.getElementById("app-report-dialog-message"),c=document.getElementById("app-report-dialog-type");if(null===t||null===n||null===i||null===s||null===r||null===o||null===a||null===c)return console.log("Error: Element is null"),void e("false");n.classList.add("is-active"),r.classList.remove("is-hidden"),o.textContent="キャンセル",t.showModal(),r.addEventListener("click",(function(){t.close();var n=document.querySelector("input[name=report-type]:checked"),i=n?n.value:"",s=a.value;e(JSON.stringify({result:!0,type:i,message:s}))})),o.addEventListener("click",(function(){t.close(),e("false")}))}))}})()})();