(()=>{"use strict";var e={6743:(e,t,n)=>{n.d(t,{$L:()=>x,$g:()=>k,A4:()=>d,Am:()=>K,As:()=>L,Cv:()=>F,FA:()=>D,Fy:()=>b,Hk:()=>r,I9:()=>H,Im:()=>j,K3:()=>a,KA:()=>h,Ku:()=>te,OE:()=>ee,T9:()=>y,Tj:()=>m,Uj:()=>l,XA:()=>v,ZQ:()=>E,bD:()=>z,cY:()=>w,dI:()=>X,eX:()=>R,g:()=>P,gR:()=>V,gz:()=>G,hp:()=>W,jZ:()=>I,kH:()=>B,kj:()=>Z,lT:()=>S,lV:()=>C,nr:()=>A,qc:()=>U,sr:()=>T,tD:()=>Q,u:()=>u,vA:()=>s,yU:()=>_,yw:()=>q,zW:()=>N});
/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function _n(e,t,n,s,r){const o=new pn;let a,c;if(n.type===St.OVERWRITE){const h=n;h.source.fromUser?a=wn(e,t,h.path,h.snap,s,r,o):((0,i.vA)(h.source.fromServer,"Unknown source."),c=h.source.tagged||t.serverCache.isFiltered()&&!Ee(h.path),a=vn(e,t,h.path,h.snap,s,r,c,o))}else if(n.type===St.MERGE){const h=n;h.source.fromUser?a=function(e,t,n,i,s,r,o){let a=t;return i.foreach(((i,c)=>{const h=be(n,i);bn(t,ge(h))&&(a=wn(e,a,h,c,s,r,o))})),i.foreach(((i,c)=>{const h=be(n,i);bn(t,ge(h))||(a=wn(e,a,h,c,s,r,o))})),a}(e,t,h.path,h.children,s,r,o):((0,i.vA)(h.source.fromServer,"Unknown source."),c=h.source.tagged||t.serverCache.isFiltered(),a=In(e,t,h.path,h.children,s,r,c,o))}else if(n.type===St.ACK_USER_WRITE){const c=n;a=c.revert?function(e,t,n,s,r,o){let a;if(null!=hn(s,n))return t;{const c=new mn(s,t,r),h=t.eventCache.getNode();let l;if(Ee(n)||".priority"===ge(n)){let n;if(t.serverCache.isFullyInitialized())n=on(s,Vt(t));else{const e=t.serverCache.getNode();(0,i.vA)(e instanceof it,"serverChildren would be complete if leaf node"),n=an(s,e)}l=e.filter.updateFullNode(h,n,o)}else{const i=ge(n);let r=un(s,i,t.serverCache);null==r&&t.serverCache.isCompleteForChild(i)&&(r=h.getImmediateChild(i)),l=null!=r?e.filter.updateChild(h,i,r,_e(n),c,o):t.eventCache.getNode().hasChild(i)?e.filter.updateChild(h,i,it.EMPTY_NODE,_e(n),c,o):h,l.isEmpty()&&t.serverCache.isFullyInitialized()&&(a=on(s,Vt(t)),a.isLeafNode()&&(l=e.filter.updateFullNode(l,a,o)))}return a=t.serverCache.isFullyInitialized()||null!=hn(s,pe()),Mt(t,l,a,e.filter.filtersNodes())}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * limitations under the License.
 */
function Ih(e){const t="undefined"!=typeof self&&(self.crypto||self.msCrypto),n=new Uint8Array(e);if(t&&"function"==typeof t.getRandomValues)t.getRandomValues(n);else for(let t=0;t<e;t++)n[t]=Math.floor(256*Math.random());return n}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function wl(e){var t,n;return"server_timestamp"===(null===(n=((null===(t=null==e?void 0:e.mapValue)||void 0===t?void 0:t.fields)||{}).__type__)||void 0===n?void 0:n.stringValue)}function bl(e){const t=e.mapValue.fields.__previous_value__;return wl(t)?bl(t):t}function El(e){const t=_l(e.mapValue.fields.__local_write_time__.timestampValue);return new kh(t.seconds,t.nanos)}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */}(e.datastore,e.asyncQueue,{Po:Mp.bind(null,e),To:Fp.bind(null,e),u_:Up.bind(null,e)}),e.F_.push((async t=>{t?(e.N_.Zo(),Op(e)?Dp(e):e.x_.set("Unknown")):(await e.N_.stop(),Lp(e))}))),e.N_}function Zp(e){return e.L_||(e.L_=function(e,t,n){const i=uh(e);return i.R_(),new Ep(t,i.connection,i.authCredentials,i.appCheckCredentials,i.serializer,n)}(e.datastore,e.asyncQueue,{Po:Hp.bind(null,e),To:Qp.bind(null,e),E_:Wp.bind(null,e),T_:Gp.bind(null,e)}),e.F_.push((async t=>{t?(e.L_.Zo(),await jp(e)):(await e.L_.stop(),e.D_.length>0&&(rh("RemoteStore",`Stopping write stream with ${e.D_.length} pending writes`),e.D_=[]))}))),e.L_
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */(e);throw oh("INTERNAL UNHANDLED ERROR: ",t),e})).then((e=>(this._u=!1,e))))));return this.nu=t,t}enqueueAfterDelay(e,t,n){this.lu(),this.uu.indexOf(e)>-1&&(t=0);const i=eg.createAndSchedule(this,e,t,n,(e=>this.Iu(e)));return this.su.push(i),i}lu(){this.ou&&hh()}verifyOperationInProgress(){}async Tu(){let e;do{e=this.nu,await e}while(e!==this.nu)}Eu(e){for(const t of this.su)if(t.timerId===e)return!0;return!1}du(e){return this.Tu().then((()=>{this.su.sort(((e,t)=>e.targetTimeMs-t.targetTimeMs));for(const t of this.su)if(t.skipDelay(),"all"!==e&&t.timerId===e)break;return this.Tu()}))}Au(e){this.uu.push(e)}Iu(e){const t=this.su.indexOf(e);this.su.splice(t,1)}}class mm extends lm{constructor(e,t,n,i){super(e,t,n,i),this.type="firestore",this._queue=new gm,this._persistenceKey=(null==i?void 0:i.name)||"[DEFAULT]"}_terminate(){return this._firestoreClient||ym(this),this._firestoreClient.terminate()}}function _m(e){return e._firestoreClient||ym(e),e._firestoreClient.verifyNotTerminated(),e._firestoreClient}function ym(e){var t,n,i;const s=e._freezeSettings(),r=function(e,t,n,i){return new Il(e,t,n,i.host,i.ssl,i.experimentalForceLongPolling,i.experimentalAutoDetectLongPolling,nm(i.experimentalLongPollingOptions),i.useFetchStreams)}(e._databaseId,(null===(t=e._app)||void 0===t?void 0:t.options.appId)||"",e._persistenceKey,s);e._firestoreClient=new Wg(e._authCredentials,e._appCheckCredentials,e._queue,r),(null===(n=s.localCache)||void 0===n?void 0:n._offlineComponentProvider)&&(null===(i=s.localCache)||void 0===i?void 0:i._onlineComponentProvider)&&(e._firestoreClient._uninitializedComponentsProvider={_offlineKind:s.localCache.kind,_offline:s.localCache._offlineComponentProvider,_online:s.localCache._onlineComponentProvider})}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * limitations under the License.
 */
class Ay{constructor(){this.providerId=Ay.PROVIDER_ID}static credential(e,t){return Ey._fromEmailAndPassword(e,t)}static credentialWithLink(e,t){const n=ky.parseLink(t);return l_(n,"argument-error"),Ey._fromEmailAndCode(e,n.code,n.tenantId)}}Ay.PROVIDER_ID="password",Ay.EMAIL_PASSWORD_SIGN_IN_METHOD="password",Ay.EMAIL_LINK_SIGN_IN_METHOD="emailLink";
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */await function(e,t){return E_(e,"POST","/v2/accounts/mfaEnrollment:start",b_(e,t))}(e,{idToken:t.credential,phoneEnrollmentInfo:{phoneNumber:r.phoneNumber,recaptchaToken:s}});return n.phoneSessionInfo.sessionInfo}{l_("signin"===t.type,e,"internal-error");const n=(null===(i=r.multiFactorHint)||void 0===i?void 0:i.uid)||r.multiFactorUid;l_(n,e,"missing-multi-factor-info");const o=await function(e,t){return E_(e,"POST","/v2/accounts/mfaSignIn:start",b_(e,t))}(e,{mfaPendingCredential:t.credential,mfaEnrollmentId:n,phoneSignInInfo:{recaptchaToken:s}});return o.phoneResponseInfo.sessionInfo}}{const{sessionInfo:t}=await async function(e,t){return E_(e,"POST","/v1/accounts:sendVerificationCode",b_(e,t))}(e,{phoneNumber:r.phoneNumber,recaptchaToken:s});return t}}finally{n._reset()}}
/**
 * @license
 * Copyright 2020 Google LLC
 *
