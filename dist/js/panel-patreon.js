 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Lf(e,t,n){if(!n)throw new Ko(zo.INVALID_ARGUMENT,`Function ${e}() cannot be called with an empty ${t}.`)}function xf(e){if(!la.isDocumentKey(e))throw new Ko(zo.INVALID_ARGUMENT,`Invalid document reference. Document references must have an even number of segments, but ${e} has ${e.length}.`)}function Mf(e){if(la.isDocumentKey(e))throw new Ko(zo.INVALID_ARGUMENT,`Invalid collection reference. Collection references must have an odd number of segments, but ${e} has ${e.length}.`)}function Uf(e){if(void 0===e)return"undefined";if(null===e)return"null";if("string"==typeof e)return e.length>20&&(e=`${e.substring(0,20)}...`),JSON.stringify(e);if("number"==typeof e||"boolean"==typeof e)return""+e;if("object"==typeof e){if(e instanceof Array)return"an array";{const t=function(e){return e.constructor?e.constructor.name:null}(e);return t?`a custom ${t} object`:"an object"}}return"function"==typeof e?"a function":Bo()}function Ff(e,t){if("_delegate"in e&&(e=e._delegate),!(e instanceof t)){if(t.name===e.constructor.name)throw new Ko(zo.INVALID_ARGUMENT,"Type does not match the expected instance. Did you pass a reference from a different Firestore SDK?");{const n=Uf(e);throw new Ko(zo.INVALID_ARGUMENT,`Expected type '${t.name}', but it was: ${n}`)}}return e}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * limitations under the License.
 */
class Bf{constructor(e,t,n){this.converter=t,this._query=n,this.type="query",this.firestore=e}withConverter(e){return new Bf(this.firestore,e,this._query)}}class qf{constructor(e,t,n){this.converter=t,this._key=n,this.type="document",this.firestore=e}get _path(){return this._key.path}get id(){return this._key.path.lastSegment()}get path(){return this._key.path.canonicalString()}get parent(){return new $f(this.firestore,this.converter,this._key.path.popLast())}withConverter(e){return new qf(this.firestore,e,this._key)}}class $f extends Bf{constructor(e,t,n){super(e,t,Qc(n)),this._path=n,this.type="collection"}get id(){return this._query.path.lastSegment()}get path(){return this._query.path.canonicalString()}get parent(){const e=this._path.popLast();return e.isEmpty()?null:new qf(this.firestore,null,new la(e))}withConverter(e){return new $f(this.firestore,e,this._path)}}function zf(t,n,...r){if(t=(0,e.Ku)(t),Lf("collection","path",n),t instanceof jf){const e=ca.fromString(n,...r);return Mf(e),new $f(t,null,e)}{if(!(t instanceof qf||t instanceof $f))throw new Ko(zo.INVALID_ARGUMENT,"Expected first argument to collection() to be a CollectionReference, a DocumentReference or FirebaseFirestore");const e=t._path.child(ca.fromString(n,...r));return Mf(e),new $f(t.firestore,null,e)}}function Kf(t,n,...r){if(t=(0,e.Ku)(t),1===arguments.length&&(n=na.newId()),Lf("doc","path",n),t instanceof jf){const e=ca.fromString(n,...r);return xf(e),new qf(t,null,new la(e))}{if(!(t instanceof qf||t instanceof $f))throw new Ko(zo.INVALID_ARGUMENT,"Expected first argument to collection() to be a CollectionReference, a DocumentReference or FirebaseFirestore");const e=t._path.child(ca.fromString(n,...r));return xf(e),new qf(t.firestore,t instanceof $f?t.converter:null,new la(e))}}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * limitations under the License.
 */
class Jf{constructor(e){this._byteString=e}static fromBase64String(e){try{return new Jf(Ha.fromBase64String(e))}catch(e){throw new Ko(zo.INVALID_ARGUMENT,"Failed to construct data from Base64 string: "+e)}}static fromUint8Array(e){return new Jf(Ha.fromUint8Array(e))}toBase64(){return this._byteString.toBase64()}toUint8Array(){return this._byteString.toUint8Array()}toString(){return"Bytes(base64: "+this.toBase64()+")"}isEqual(e){return this._byteString.isEqual(e._byteString)}}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * limitations under the License.
 */
class Yf{constructor(e,t){if(!isFinite(e)||e<-90||e>90)throw new Ko(zo.INVALID_ARGUMENT,"Latitude must be a number between -90 and 90, but was: "+e);if(!isFinite(t)||t<-180||t>180)throw new Ko(zo.INVALID_ARGUMENT,"Longitude must be a number between -180 and 180, but was: "+t);this._lat=e,this._long=t}get latitude(){return this._lat}get longitude(){return this._long}isEqual(e){return this._lat===e._lat&&this._long===e._long}toJSON(){return{latitude:this._lat,longitude:this._long}}_compareTo(e){return ra(this._lat,e._lat)||ra(this._long,e._long)}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Zf=new RegExp("[~\\*/\\[\\]]");function ep(e,t,n){if(t.search(Zf)>=0)throw tp(`Invalid field path (${t}). Paths must not contain '~', '*', '/', '[', or ']'`,e,!1,void 0,n);try{return new Xf(...t.split("."))._internalPath}catch(r){throw tp(`Invalid field path (${t}). Paths must not be empty, begin with '.', end with '.', or contain '..'`,e,!1,void 0,n)}}function tp(e,t,n,r,i){const s=r&&!r.isEmpty(),o=void 0!==i;let a=`Function ${t}() called with invalid data`;n&&(a+=" (via `toFirestore()`)"),a+=". ";let c="";return(s||o)&&(c+=" (found",s&&(c+=` in field ${r}`),o&&(c+=` in document ${i}`),c+=")"),new Ko(zo.INVALID_ARGUMENT,a+e+c)}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * limitations under the License.
 */
class np{constructor(e,t,n,r,i){this._firestore=e,this._userDataWriter=t,this._key=n,this._document=r,this._converter=i}get id(){return this._key.path.lastSegment()}get ref(){return new qf(this._firestore,this._converter,this._key)}exists(){return null!==this._document}data(){if(this._document){if(this._converter){const e=new rp(this._firestore,this._userDataWriter,this._key,this._document,null);return this._converter.fromFirestore(e)}return this._userDataWriter.convertValue(this._document.data.value)}}get(e){if(this._document){const t=this._document.data.field(ip("DocumentSnapshot.get",e));if(null!==t)return this._userDataWriter.convertValue(t)}}}class rp extends np{data(){return super.data()}}function ip(e,t){return"string"==typeof t?ep(e,t):t instanceof Xf?t._internalPath:t._delegate._internalPath}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * limitations under the License.
 */
class ap{constructor(e,t){this.hasPendingWrites=e,this.fromCache=t}isEqual(e){return this.hasPendingWrites===e.hasPendingWrites&&this.fromCache===e.fromCache}}class cp extends np{constructor(e,t,n,r,i,s){super(e,t,n,r,s),this._firestore=e,this._firestoreImpl=e,this.metadata=i}exists(){return super.exists()}data(e={}){if(this._document){if(this._converter){const t=new up(this._firestore,this._userDataWriter,this._key,this._document,this.metadata,null);return this._converter.fromFirestore(t,e)}return this._userDataWriter.convertValue(this._document.data.value,e.serverTimestamps)}}get(e,t={}){if(this._document){const n=this._document.data.field(ip("DocumentSnapshot.get",e));if(null!==n)return this._userDataWriter.convertValue(n,t.serverTimestamps)}}}class up extends cp{data(e={}){return super.data(e)}}class hp{constructor(e,t,n,r){this._firestore=e,this._userDataWriter=t,this._snapshot=r,this.metadata=new ap(r.hasPendingWrites,r.fromCache),this.query=n}get docs(){const e=[];return this.forEach((t=>e.push(t))),e}get size(){return this._snapshot.docs.size}get empty(){return 0===this.size}forEach(e,t){this._snapshot.docs.forEach((n=>{e.call(t,new up(this._firestore,this._userDataWriter,n.key,n,new ap(this._snapshot.mutatedKeys.has(n.key),this._snapshot.fromCache),this.query.converter))}))}docChanges(e={}){const t=!!e.includeMetadataChanges;if(t&&this._snapshot.excludesMetadataChanges)throw new Ko(zo.INVALID_ARGUMENT,"To include metadata changes with your document changes, you must also pass { includeMetadataChanges:true } to onSnapshot().");return this._cachedChanges&&this._cachedChangesIncludeMetadataChanges===t||(this._cachedChanges=function(e,t){if(e._snapshot.oldDocs.isEmpty()){let t=0;return e._snapshot.docChanges.map((n=>{const r=new up(e._firestore,e._userDataWriter,n.doc.key,n.doc,new ap(e._snapshot.mutatedKeys.has(n.doc.key),e._snapshot.fromCache),e.query.converter);return n.doc,{type:"added",doc:r,oldIndex:-1,newIndex:t++}}))}{let n=e._snapshot.oldDocs;return e._snapshot.docChanges.filter((e=>t||3!==e.type)).map((t=>{const r=new up(e._firestore,e._userDataWriter,t.doc.key,t.doc,new ap(e._snapshot.mutatedKeys.has(t.doc.key),e._snapshot.fromCache),e.query.converter);let i=-1,s=-1;return 0!==t.type&&(i=n.indexOf(t.doc.key),n=n.delete(t.doc.key)),1!==t.type&&(n=n.add(t.doc),s=n.indexOf(t.doc.key)),{type:lp(t.type),doc:r,oldIndex:i,newIndex:s}}))}}(this,t),this._cachedChangesIncludeMetadataChanges=t),this._cachedChanges}}function lp(e){switch(e){case 0:return"added";case 2:case 3:return"modified";case 1:return"removed";default:return Bo()}}class dp extends op{constructor(e){super(),this.firestore=e}convertBytes(e){return new Jf(e)}convertReference(e){const t=this.convertDocumentKey(e,this.firestore._databaseId);return new qf(this.firestore,null,t)}}function fp(e){e=Ff(e,Bf);const t=Ff(e.firestore,Gf),n=Wf(t),r=new dp(t);return sp(e._query),Rf(n,e._query).then((n=>new hp(t,r,e,n)))}function pp(e,t){return function(e,t){const n=new Ho;return e.asyncQueue.enqueueAndForget((async()=>async function(e,t,n){const r=wf(e);try{const e=await function(e,t){const n=$o(e),r=sa.now(),i=t.reduce(((e,t)=>e.add(t.key)),_u());let s,o;return n.persistence.runTransaction("Locally write mutations","readwrite",(e=>{let a=lu(),c=_u();return n.os.getEntries(e,i).next((e=>{a=e,a.forEach(((e,t)=>{t.isValidDocument()||(c=c.add(e))}))})).next((()=>n.localDocuments.getOverlayedDocuments(e,a))).next((i=>{s=i;const o=[];for(const e of t){const t=zu(e,s.get(e.key).overlayedDocument);null!=t&&o.push(new Gu(e.key,t,vc(t.value.mapValue),Fu.exists(!0)))}return n.mutationQueue.addMutationBatch(e,r,o,t)})).next((t=>{o=t;const r=t.applyToLocalDocumentSet(s,c);return n.documentOverlayCache.saveOverlays(e,t.batchId,r)}))})).then((()=>({batchId:o.batchId,changes:pu(s)})))}(r.localStore,t);r.sharedClientState.addPendingMutation(e.batchId),function(e,t,n){let r=e.Fa[e.currentUser.toKey()];r||(r=new Va(ra)),r=r.insert(t,n),e.Fa[e.currentUser.toKey()]=r}(r,e.batchId,n),await gf(r,e.changes),await md(r.remoteStore)}catch(e){const t=Dd(e,"Failed to persist write");n.reject(t)}}(await Nf(e),t,n))),n.promise}(Wf(e),t)}new WeakMap;
/**
 * @license
 * Copyright 2023 Google LLC
 *
 ...
 * limitations under the License.
 */
function(n,r){const i=(0,t.j6)(n,"auth");if(i.isInitialized()){const t=i.getImmediate(),n=i.getOptions();if((0,e.bD)(n,null!=r?r:{}))return t;l(t,"already-initialized")}return i.initialize({options:r})}(n,{popupRedirectResolver:sn,persistence:[ft,Je,Ye]}),s=(0,e.XA)("authTokenSyncURL");if(s&&s.match(/^\/[^\/].*/)){const t=(o=s,async e=>{const t=e&&await e.getIdTokenResult(),n=t&&((new Date).getTime()-Date.parse(t.issuedAtTime))/1e3;if(n&&n>un)return;const r=null==t?void 0:t.token;hn!==r&&(hn=r,await fetch(o,{method:r?"POST":"DELETE",headers:r?{Authorization:`Bearer ${r}`}:{}}))});!function(t,n,r){(0,e.Ku)(t).beforeAuthStateChanged(n,r)}(i,t,(()=>t(i.currentUser))),function(t,n,r,i){(0,e.Ku)(t).onIdTokenChanged(n,r,i)}(i,(e=>t(e)))}var o;const a=(0,e.Tj)("auth");return a&&Ee(i,`http://${a}`),i}(),Ep=function(n,r){const i="object"==typeof n?n:(0,t.Sx)(),s="string"==typeof n?n:r||"(default)",o=(0,t.j6)(i,"firestore").getImmediate({identifier:s});if(!o._initialized){const t=(0,e.yU)("firestore");t&&function(t,n,r,i={}){var s;const o=(t=Ff(t,jf))._getSettings(),a=`${n}:${r}`;if("firestore.googleapis.com"!==o.host&&o.host!==a&&Vo("Host has been set in both settings() and connectFirestoreEmulator(), emulator host will be used."),t._setSettings(Object.assign(Object.assign({},o),{host:a,ssl:!1})),i.mockUserToken){let n,r;if("string"==typeof i.mockUserToken)n=i.mockUserToken,r=Po.MOCK_USER;else{n=(0,e.Fy)(i.mockUserToken,null===(s=t._app)||void 0===s?void 0:s.options.projectId);const o=i.mockUserToken.sub||i.mockUserToken.user_id;if(!o)throw new Ko(zo.INVALID_ARGUMENT,"mockUserToken must contain 'sub' or 'user_id' field!");r=new Po(o)}t._authCredentials=new Qo(new Go(n,r))}}(o,...t)}return o}();!function(t,n,r,i){(0,e.Ku)(t).onAuthStateChanged(n,r,i)}(_p,(function(e){return vp(void 0,void 0,void 0,(function(){var t,n,r,i,s;return wp(this,(function(o){switch(o.label){case 0:if(null===e)throw window.location.href="/auth/signin.html",new mp("User is not signed in");return t=document.getElementById("buttonLinkPatreon"),n=document.getElementById("labelLinkInfo"),r=document.getElementById("labelUnlinkPatreon"),i=document.getElementById("unlinkConfirm"),s=document.getElementById("buttonUnlinkPatreon"),[4,fp(zf(Ep,"patreonlinkstatus-"+e.uid))];case 1:return o.sent().forEach((function(e){switch(e.data().plan){case"owner":t.textContent="オーナー権限はアクティブです";break;case"enhanced":t.textContent="Enhancedはアクティブです";break;case"premium":t.textContent="プレミアムはアクティブです";break;case"standard":t.textContent="Standardはアクティブです";break;case"free":t.textContent="Patreonと連携済み"}t.setAttribute("disabled","true"),n.classList.remove("is-hidden")})),r.addEventListener("click",(function(){var e;null===(e=document.getElementById("unlinkConfirm_modal"))||void 0===e||e.classList.add("is-active"),i.showModal()})),s.addEventListener("click",(function(){return vp(void 0,void 0,void 0,(function(){return wp(this,(function(t){switch(t.label){case 0:return[4,fp(zf(Ep,"patreonlinkstatus-"+e.uid))];case 1:return t.sent().forEach((function(t){return vp(void 0,void 0,void 0,(function(){return wp(this,(function(n){switch(n.label){case 0:return[4,(r=Kf(Ep,"patreonlinkstatus-"+e.uid,t.id),pp(Ff(r.firestore,Gf),[new Xu(r._key,Fu.none())])).then((function(){window.location.reload()}))];case 1:return n.sent(),[2]}var r}))}))})),[2]}}))}))})),[2]}}))}))})),window.addEventListener("DOMContentLoaded",(function(){if(window.location.href.includes("10.249.176.251:8080")){var e=document.getElementById("localLinkAccount_Container");e&&e.classList.remove("is-hidden")}}))})()})();