 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function qe(e,t,n){var i;const r=ve(e),s={requestType:"PASSWORD_RESET",email:t,clientType:"CLIENT_TYPE_WEB"};if(null===(i=r._getRecaptchaConfig())||void 0===i?void 0:i.emailPasswordEnabled){const e=await pe(r,s,"getOobCode",!0);n&&Ge(r,e,n),await ke(r,e)}else n&&Ge(r,s,n),await ke(r,s).catch((async e=>{if("auth/missing-recaptcha-token"!==e.code)return Promise.reject(e);{console.log("Password resets are protected by reCAPTCHA for this project. Automatically triggering the reCAPTCHA flow and restarting the password reset flow.");const e=await pe(r,s,"getOobCode",!0);n&&Ge(r,e,n),await ke(r,e)}}))}function Xe(e,t,n,r){return(0,i.Ku)(e).onAuthStateChanged(t,n,r)}new WeakMap;const Je="__sak";
/**
 * @license
 * Copyright 2019 Google LLC
 *
