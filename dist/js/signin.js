 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function ot(t){const e=t.toLowerCase();if(e.includes("opera/")||e.includes("opr/")||e.includes("opios/"))return"Opera";if(lt(e))return"IEMobile";if(e.includes("msie")||e.includes("trident/"))return"IE";if(e.includes("edge/"))return"Edge";if(at(e))return"Firefox";if(e.includes("silk/"))return"Silk";if(dt(e))return"Blackberry";if(ft(e))return"Webos";if(ht(e))return"Safari";if((e.includes("chrome/")||ct(e))&&!e.includes("edge/"))return"Chrome";if(ut(e))return"Android";{const e=/([a-zA-Z\d\.]+)\/[a-zA-Z\d\.]*$/,n=t.match(e);if(2===(null==n?void 0:n.length))return n[1]}return"Other"}function at(t=(0,r.ZQ)()){return/firefox\//i.test(t)}function ht(t=(0,r.ZQ)()){const e=t.toLowerCase();return e.includes("safari/")&&!e.includes("chrome/")&&!e.includes("crios/")&&!e.includes("android")}function ct(t=(0,r.ZQ)()){return/crios\//i.test(t)}function lt(t=(0,r.ZQ)()){return/iemobile/i.test(t)}function ut(t=(0,r.ZQ)()){return/android/i.test(t)}function dt(t=(0,r.ZQ)()){return/blackberry/i.test(t)}function ft(t=(0,r.ZQ)()){return/webos/i.test(t)}function pt(t=(0,r.ZQ)()){return/iphone|ipad|ipod/i.test(t)||/macintosh/i.test(t)&&/mobile/i.test(t)}function gt(t=(0,r.ZQ)()){return pt(t)||ut(t)||ft(t)||dt(t)||/windows phone/i.test(t)||lt(t)}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class de{constructor(t,e){this.storageRetriever=t,this.type=e}_isAvailable(){try{return this.storage?(this.storage.setItem(ue,"1"),this.storage.removeItem(ue),Promise.resolve(!0)):Promise.resolve(!1)}catch(t){return Promise.resolve(!1)}}_set(t,e){return this.storage.setItem(t,JSON.stringify(e)),Promise.resolve()}_get(t){const e=this.storage.getItem(t);return Promise.resolve(e?JSON.parse(e):null)}_remove(t){return this.storage.removeItem(t),Promise.resolve()}get storage(){return this.storageRetriever()}}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * limitations under the License.
 */
const cn=new S(5e3,15e3),ln="__/auth/iframe",un="emulator/auth/iframe",dn={style:{position:"absolute",top:"-100px",width:"1px",height:"1px"},"aria-hidden":"true",tabindex:"-1"},fn=new Map([["identitytoolkit.googleapis.com","p"],["staging-identitytoolkit.sandbox.googleapis.com","s"],["test-identitytoolkit.sandbox.googleapis.com","t"]]);function pn(t){const e=t.config;w(e.authDomain,t,"auth-domain-config-required");const n=e.emulator?A(e,un):`https://${t.config.authDomain}/${ln}`,s={apiKey:e.apiKey,appName:t.name,v:i.MF},o=fn.get(t.config.apiHost);o&&(s.eid=o);const a=t._getFrameworks();return a.length&&(s.fw=a.join(",")),`${n}?${(0,r.Am)(s).slice(1)}`}async function gn(t){const e=await function(t){return hn=hn||an(t),hn}(t),n=Ie().gapi;return w(n,t,"internal-error"),e.open({where:document.body,url:pn(t),messageHandlersFilter:n.iframes.CROSS_ORIGIN_IFRAMES_FILTER,attributes:dn,dontclear:!0},(e=>new Promise((async(n,i)=>{await e.restyle({setHideOnLeave:!1});const r=p(t,"network-request-failed"),s=Ie().setTimeout((()=>{i(r)}),cn.get());function o(){Ie().clearTimeout(s),n(e)}e.ping(o).then(o,(()=>{i(r)}))}))))}
/**
 * @license
 * Copyright 2020 Google LLC.
 *
 ...
 * limitations under the License.
 */
function U(t){return t&&t._delegate?t._delegate:t}},6582:(t,e,n)=>{n.d(e,{j:()=>h});var i=n(1990);
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * limitations under the License.
 */
const ct="10.10.0";function lt(t,e={}){let n=t;if("object"!=typeof e){e={name:e}}const r=Object.assign({name:Y,automaticDataCollectionEnabled:!1},e),o=r.name;if("string"!=typeof o||!o)throw at.create("bad-app-name",{appName:String(o)});if(n||(n=(0,s.T9)()),!n)throw at.create("no-options");const a=Q.get(o);if(a){if((0,s.bD)(n,a.options)&&(0,s.bD)(r,a.config))return a;throw at.create("duplicate-app",{appName:o})}const h=new i.h1(o);for(const t of et.values())h.addComponent(t);const c=new ht(n,r,h);return Q.set(o,c),c}function ut(t=Y){const e=Q.get(t);if(!e&&t===Y&&(0,s.T9)())return lt();if(!e)throw at.create("no-app",{appName:t});return e}function dt(t,e,n){var r;let s=null!==(r=Z[t])&&void 0!==r?r:t;n&&(s+=`-${n}`);const o=s.match(/\s|\//),a=e.match(/\s|\//);if(o||a){const t=[`Unable to register library "${s}" with version "${e}":`];return o&&t.push(`library name "${s}" contains illegal characters (whitespace or "/")`),o&&a&&t.push("and"),a&&t.push(`version name "${e}" contains illegal characters (whitespace or "/")`),void A.warn(t.join(" "))}it(new i.uA(`${s}-version`,(()=>({library:s,version:e})),"VERSION"))}
/**
 * @license
 * Copyright 2021 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */var Tt;Tt="",it(new i.uA("platform-logger",(t=>new E(t)),"PRIVATE")),it(new i.uA("heartbeat",(t=>new It(t)),"PRIVATE")),dt(T,S,Tt),dt(T,S,"esm2017"),dt("fire-js","")},5125:(t,e,n)=>{n.d(e,{h1:()=>a,uA:()=>r});var i=n(6743);class r{constructor(t,e,n){this.name=t,this.instanceFactory=e,this.type=n,this.multipleInstances=!1,this.serviceProps={},this.instantiationMode="LAZY",this.onInstanceCreated=null}setInstantiationMode(t){return this.instantiationMode=t,this}setMultipleInstances(t){return this.multipleInstances=t,this}setServiceProps(t){return this.serviceProps=t,this}setInstanceCreatedCallback(t){return this.onInstanceCreated=t,this}}
/**
 * @license
 * Copyright 2019 Google LLC
 *
